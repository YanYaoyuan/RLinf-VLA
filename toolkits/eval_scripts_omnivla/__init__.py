...
import omni_vla.policies.policy as _policy
import omni_vla.shared.download as download
import omni_vla.transforms as transforms
import safetensors
from omni_vla.models_pytorch import omni_vla
from omni_vla.training import checkpoints as _checkpoints
from omni_vla.training import config as _config

from rlinf.models.embodiment.omni_vla.dataconfig import _CONFIGS_DICT
...
def load_pytorch(train_config, weight_path: str):
    model = omni_vla.OmniVLA(config=train_config.model, device="cuda")
